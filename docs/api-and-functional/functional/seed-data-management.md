...
| `V008__init_plans.sql` ~ `V012__init_audit_logs.sql` | DDL — 결제(plans · subscriptions · webhook_events · renewal_attempts) · audit |
| `V013__add_totp_to_users.sql` ~ `V015__init_phone_otp_codes.sql` | DDL — 2FA · 알림 설정 · 점유인증 OTP |
