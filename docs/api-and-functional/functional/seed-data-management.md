...
| `V008__init_subscription_plans.sql` ~ `V012__init_audit_logs.sql` | DDL — 결제(subscription_plans · subscriptions · payment_webhook_events · subscription_renewals) · audit |
