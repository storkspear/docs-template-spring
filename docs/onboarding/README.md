...
| 📖 프로젝트 철학 | 3 | 2~3시간 | [`17 ADR 인덱스`](../philosophy/README.md) · 테마 1~5 (모듈/데이터/인증/운영/내부설계/OAuth) |
...
| 궁금한 것 | 문서 | 한 줄 |
|---|---|---|
| 왜 이렇게 설계? | [`Repository Philosophy — 책 안내`](../philosophy/README.md) | 17 ADR · 프롤로그 3 제약 |
