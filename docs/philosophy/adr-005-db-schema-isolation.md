...
`./tools/app/new-app.sh <slug>` 한 줄이 5중 방어선 중 **4개** 를 자동 생성합니다 (방어선 5 는 공용 규칙이라 추가 생성 없음).
...
**자동화**:
- [`tools/app/new-app.sh`](https://github.com/storkspear/template-spring/blob/main/tools/app/new-app.sh) — 앱 한 개 스캐폴딩 전체
