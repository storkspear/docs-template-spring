...
**앱 추가 비용이 거의 제로** — `./tools/new-app/new-app.sh sumtally` 한 줄로 schema · role · DataSource · 6개 마이그레이션 + AuthController · AutoConfiguration 까지 셋업. 솔로 운영자가 새 앱 착수 시 DB 셋업 시간 5분 미만이에요.
