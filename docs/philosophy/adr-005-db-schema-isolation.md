...
- [`tools/new-app/new-app.sh`](https://github.com/storkspear/template-spring/blob/main/tools/new-app/new-app.sh) — 마이그레이션 템플릿 자동 생성 (기본 25개 V001~V026, `V007` 은 `--seed-admin` opt-in)
