...
| 문서 | 범위 |
|---|---|
| [`Repository Philosophy — 책 안내`](../../philosophy/README.md) | **코드 설계 결정 (38 ADR)** — 모듈 구조, 포트/어댑터, Mapper 금지, 테스트 전략 등 |
...
- [`Repository Philosophy — 책 안내`](../../philosophy/README.md) — 코드 설계 결정 (38 ADR)
