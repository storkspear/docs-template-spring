...
프로젝트의 환경별 인프라 구성, 책임 분담, 프로비저닝 상태를 기록합니다. 코드 아키텍처의 **왜** 는 [`philosophy/` 17 개 ADR](../../philosophy/README.md) 에, **무엇/어디** 는 [`Architecture Reference`](../../structure/architecture.md) 에 있으며, 이 문서는 그 위에서 **운영 환경의 실체** 를 다룹니다.
...
- [`Repository Philosophy — 책 안내`](../../philosophy/README.md) — 17 개 ADR 인덱스 (설계 결정의 근거)
