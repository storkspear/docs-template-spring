...
마이그레이션 V001~V017 이 인증·결제·감사 등 기반 테이블을 만들고, 그 사이의 **V007 은 테이블이 아니라 admin 계정 시드(DML)** 입니다. V018~V025 는 도메인 확장분(첨부·열람이력·발송이력·감사아카이브·환불원장·게시물·애널리틱스)으로, 위 카탈로그는 그중 콘솔·스키마 참조가 잦은 테이블을 담았어요.
