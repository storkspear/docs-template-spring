...
# 폐기:
<repo> dev clear         # 인프라만 정리 (Supabase·MinIO bucket 보존)
...
<repo> ci-test
   ...
   → [2/5] Build (compile + unit test + ArchUnit r1~r22 (r12 예약, 활성 21) + jacoco)
...
dev clear · prod clear:     인프라 정리 — 데이터 보존
